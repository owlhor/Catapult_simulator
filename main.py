# ===========================================================#
# Catapult simulator Program V1.2
...
mainfrm.title("FRA163 x FRA142 Catapult Simulator V1.2")
...
def prender():
    try:
        dista =  float(ent_distance.get())
        high = float(ent_high.get())
        anglr = float(ent_angle.get())
        kspr = float(ent_kspr.get())
    except:
